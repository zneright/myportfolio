            ...
            <div className="slider-viewport" onClick={e => e.stopPropagation()}>
                <div className="slider-controls-top">
                    <div className="project-info-mini">
                        <h4>{title}</h4>
                        <p>{currentIndex + 1} / {gallery.length} SAMPLES (Scroll image to see bottom)</p>
                    </div>
                ...
                <div className="main-display">
                    ...
                    {/* NEW: Scrollable area for the full screenshot */}
                    <div className="image-stage scrollable-stage">
                        <img
                            src={gallery[currentIndex]}
                            alt="Full Screenshot"
                            className="active-slide full-length-image"
                        />
                    </div>
                ...
                <div className="project-card" onClick={() => setIsModalOpen(true)}>
                    <div className="image-stack-container">
                        ...
                        <div className="image-main-wrapper">
                            ...
                            <div className="hover-hint">Hover to see full height</div>
